...
Para empezar, vamos a desglosar un poco esas categorías en orden decreciente al rendimiento, es decir, **los más eficientes primero**, categorizándolos usando [la notación $\Omicron(x)$](#notación-oomicrono).
